...
export const CustomerNotificationsDropdown: React.FC<{ onClose: () => void; onOpenApproval: (id: string) => void }> = ({
  onClose,
  onOpenApproval,
}) => {
    ...
    <div ref={ref} className="absolute right-0 top-10 z-40 w-96 overflow-hidden rounded-xl border border-line bg-white shadow-pop">
      ...
      <div className="max-h-96 overflow-y-auto">
        ...
        {notifications.map((n) => (
          ...
          >
            <div className="mt-0.5 flex h-8 w-8 flex-none items-center justify-center rounded-full bg-amber-100 text-amber-700">
            ...
            <div className="min-w-0 flex-1">
              ...
              <span className="mt-1 inline-block text-xs font-medium text-navy">View Approval →</span>
            </div>
          </button>
        ))}
      </div>
