...
export const INITIAL_APPROVALS: Approval[] = [
  ...
  build({
    ...
    partNumber: '123456',
    partDescription: 'Turbine Blade',
    requirement:
      'The turbine blade needs extra repair beyond what was originally approved, based on the inspection findings. We need your approval before we can proceed.',
    cost: 12500,
    status: 'Open',
  ...
  build({
    ...
    subtype: 'Exchange',
    partNumber: '552341',
    partDescription: 'Fuel Nozzle',
    requirement: 'The fuel nozzle is damaged and cannot be repaired. It needs to be exchanged for a working unit.',
    cost: 18400,
    status: 'Open',
